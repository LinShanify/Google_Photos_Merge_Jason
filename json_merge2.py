...
#             "\"-ImageDescription<Description\" \"-CreateDate<PhotoTakenTimeTimestamp\" " \
#             "-ext mp4 -overwrite_original "

merge_cmd = "exiftool -r -d %s -tagsfromfile \"%d/%f.json\" " \
            "\"-MediaCreateDate<PhotoTakenTimeTimestamp\" \"-CreationDate-und-US<PhotoTakenTimeTimestamp\" " \
